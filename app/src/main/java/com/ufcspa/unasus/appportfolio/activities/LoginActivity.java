...
//        Log.d("lista","portfolio:"+lista.toString());
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public synchronized void onClick(View view) {
                if (isOnline()) {
//                    showProgress(true);
                    dialog = ProgressDialog.show(LoginActivity.this, "Baixando novos dados", "Por favor aguarde...", true);
                    final Thread myThread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if( !isDataSyncNotSucessful) {
                                ...
                                if (!isBasicDataSyncNotSucessful) {
                                    mDataBase.updateDeviceBasicDataSync();
...
//                                        showProgress(false);
    ...
    private void loginSuccess() {
        ...
        //  Log.d("singletonn", "id:" + sSingleton.mUser.getIdUser() + " uT:" + sSingleton.mUser.getUserType());
    ...
    private boolean verificarLogin() {
        ...
        //  try {
//            DataBase mDataBase = DataBase.getInstance(this);
//            mUser = mDataBase.verifyPass(mEmailView.getText().toString(), mPasswordView.getText().toString());
        //result=mUser.getIdUser();
        //Log.d("BANCO", " pass:" + result);
//        if (isOnline()) {
        FirstLogin first = new FirstLogin();

        String androidId = Settings.Secure.getString(this.getContentResolver(), Settings.Secure.ANDROID_ID);
        Log.d("ANDROID ID", "Android ID:" + androidId);
        String tpDevice = (isTablet()) ? "T" : "C";
        first.setIdDevice(androidId);
        ...
        //ADD TO SINGLETON
        Singleton.getInstance().device.set_id_device(androidId);
