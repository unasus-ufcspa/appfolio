...
public class ColorWheelView extends View {
     ...
     * </p>
     */
    private static final int[] COLORS = {0xFFFF0000, 0xFFFF00FF, 0xFF0000FF, 0xFF00FFFF, 0xFF00FF00, 0xFFFFFF00, 0xFFFF0000};
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.ColorWheelView, defStyle, 0);
        final Resources b = getContext().getResources();

        mColorWheelEnabled = a.getBoolean(
                R.styleable.ColorWheelView_color_wheel_enabled, true);
        mColorWheelThickness = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_wheel_thickness,
                b.getDimensionPixelSize(R.dimen.color_wheel_thickness));
        mColorWheelRadius = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_wheel_radius,
        ...
        mColorCenterRadius = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_center_radius,
        ...
        mColorCenterHaloRadius = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_center_halo_radius,
        ...
        mColorPointerRadius = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_pointer_radius,
                b.getDimensionPixelSize(R.dimen.color_pointer_radius));
        mColorPointerHaloRadius = a.getDimensionPixelSize(
                R.styleable.ColorWheelView_color_pointer_halo_radius,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mAlphaPattern != null) {
            canvas.save();
            canvas.clipPath(mCenterClipping);
        ...
        if (mShowCenterOldColor) {
            ...
            canvas.drawArc(mCenterRectangleF, 90, 180, true, mCenterOldPaint);

            // Draw the new selected color in the center.
            canvas.drawArc(mCenterRectangleF, 270, 180, true, mCenterNewPaint);
        } else {
            // Draw the new selected color in the center.
            canvas.drawArc(mCenterRectangleF, 0, 360, true, mCenterNewPaint);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCenterRectangleF.set(-mColorCenterRadius, -mColorCenterRadius, mColorCenterRadius, mColorCenterRadius);
        mCenterRectangle.set(-mColorCenterRadius, -mColorCenterRadius, mColorCenterRadius, mColorCenterRadius);
        mCenterClipping.reset();
        mCenterClipping.addCircle(0, 0, mColorCenterRadius - 0.5f, Direction.CW);

        int size = mColorWheelEnabled ? min : mColorCenterRadius * 2;
        setMeasuredDimension(size, size);
        mTranslationOffset = size * .5f;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mOnColorSelectedListener != null && mCenterNewColor != mOldSelectedListenerColor) {
                    mOnColorSelectedListener.onColorSelected(mCenterNewColor);
                    mOldSelectedListenerColor = mCenterNewColor;
                }
