 ...
 * attributes, and a schema to which it belongs.
 *
 * @see Schema
 */
...
public class ElementType {
     ...
     * instead. The content model, member-of, and flags vectors are specified as
     * ints.
     *
     * @param name     The element type name
     * @param model    ORed-together bits representing the content models allowed in
     *                 the content of this element type
     * @param memberOf ORed-together bits representing the content models to which
     *                 this element type belongs
     * @param flags    ORed-together bits representing the flags associated with this
     *                 element type
     ...
     *
     * @return The content models to which this element type belongs as a vector
     * of bits
     */
     ...
     * Attributes of type CDATA that don't have default values are typically not
     * included. Other attributes without default values have an internal value
     * of <tt>null</tt>. The return value is an AttributesImpl to allow the
    ...
    /**
     * Returns true if this element type can contain another element type. That
     * is, if any of the models in this element's model vector match any of the
     * models in the other element type's member-of vector.
     *
    ...
    /**
     * Sets an attribute and its value into an AttributesImpl object. Attempts
     ...
     *
     * @param memberOf The content models to which this element type belongs as a
     *                 vector of bits
     */
     ...
     *
     * @param flags associated with this element type The flags as a vector of
     *              bits
     */
